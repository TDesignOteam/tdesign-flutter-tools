...
void main() {
  test('TCalendarDateType enum members include /// documentation', () {
    ...
    final solar = info.componentInfo!.enumMembers.firstWhere(
      (EnumMemberInfo m) => m.name == 'solar',
    );
    final lunar = info.componentInfo!.enumMembers.firstWhere(
      (EnumMemberInfo m) => m.name == 'lunar',
    );
