...
/// CI 通过环境变量 `TDESIGN_COMPONENT_ROOT` 注入；本地优先使用 ../tdesign-flutter/tdesign-component。
String get tdesignComponentRoot {
  ...
  throw StateError(
    '未找到 tdesign-component。请设置 TDESIGN_COMPONENT_ROOT 或放置 ../tdesign-flutter/tdesign-component。',
  );
}
